  ...
  function updateCountdown(){
    ...
    if(stickyEl) stickyEl.textContent = d + " day" + (d===1?"":"s") + " left · 2 seats";
  }
  updateCountdown();
  ...
  document.getElementById('apply-form').addEventListener('submit', function(e){
    ...
    var subject = encodeURIComponent("Run Iceland application — " + data.name);
    var body = encodeURIComponent(
      "Name: " + data.name + "\n" +
      "Instagram: " + data.instagram + "\n" +
      "Email: " + data.email + "\n" +
      "Phone: " + data.phone + "\n" +
      "Running background: " + data.experience + "\n" +
      "Message: " + data.message
    );
    window.location.href = "mailto:sai@digicarotene.com?subject=" + subject + "&body=" + body;
